...
public class AnnouncementEmployee extends Fragment {
    ...
    String [] desc = {"Report at noon","Report midnight","report in morning"};
    String [] detail = {"employees must report to the manager","employees must report to the manager","employees must report to the manager"};
    ...
    private void initDataset() {
        mDataset = new String[desc.length];
